...
Public Class employees
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDelete.Click
        Try
            sql = "Delete from Employee where EmpID= " & lblEmpID.Text & " "
            cmd = New OleDbCommand(sql, objcn.cn)
            cmd.ExecuteNonQuery()
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            sql = "select * from Employee where EmpID = " & lblEmpID.Text & " "
            cmd = New OleDbCommand(sql, objcn.cn)
    ...
    Protected Sub tblEmp_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles tblEmp.SelectedIndexChanged
        Try
            sql = "select * from Employee where EmpID = " & tblEmp.SelectedRow.Cells(1).Text & " "
            cmd = New OleDbCommand(sql, objcn.cn)
